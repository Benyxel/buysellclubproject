        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              Direct Access to{" "}
              <span className="text-green-500">Verified Suppliers</span> in
              China
            </h2>

            <p className="text-lg md:text-xl text-gray-300 dark:text-gray-400 leading-relaxed">
              Build strong partnerships with trusted Chinese manufacturers and
              suppliers. We connect you directly to quality suppliers, ensuring
              competitive prices and reliable sourcing for your business needs.
            </p>
